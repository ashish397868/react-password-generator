...
function PasswordGenerator() {
  ...
  }, [containsLowerCase, containsNumber, containsSymbols, containsUpperCase])
  ...
  return (
    <>
      <div className="main w-[90vw] sm:w-[50vw] lg:w-[30vw] xsm:w-[90vw] p-7 rounded-md mt-28 text-xl border border-red-100 flex flex-col bg-gradient-to-br from-cyan-100 to bg-cyan-300">
        <h1 className="text-center text-3xl font-bold mt-1 ">Random Password Generator</h1>
        ...
        <div className="form-Group">
          <label htmlFor="large-range" className="block mb-2  font-medium text-gray-900 dark:text-white">
            {" "}
            PassWord Length
          </label>
          <span className="bg-gradient-to-br from-cyan-300 to bg-cyan-500 w-7 h-6 text-center">{passwordLength}</span>
          <input
            id="large-range"
            type="range"
            min="8"
            ...
            className="w-36 h-3 bg-gray-200 mt-2 rounded-lg appearance-none cursor-pointer range-lg dark:bg-gray-700"
          />
        </div>
